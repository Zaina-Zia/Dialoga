...
export const demoCategories: CategoryItem[] = [
  {
    id: 'interesado',
    title: 'Interesado',
    imageSrc: '/images/Dashboard_Home/CustomerCategories/interesado.svg',
  ...
  },
  {
    id: 'delivery',
    title: 'Delivery',
    imageSrc: '/images/Dashboard_Home/envio.svg',
    color: 'text-emerald-600',
    isOpen: false,
  },
  {
    id: 'va-en-persona',
    title: 'Va En Persona',
    imageSrc: '/images/Dashboard_Home/visitas.svg',
    color: 'text-emerald-600',
    isOpen: false,
  },
  {
    ...
    imageSrc: '/images/Dashboard_Home/CustomerCategories/soloPriceinfo.svg',
    color: 'text-emerald-600',
    isOpen: false,
  },
  {
    id: 'no-interesado',
    title: 'No Interesado',
    imageSrc: '/images/Dashboard_Home/CustomerCategories/noIntersado.svg',
    color: 'text-emerald-600',
    isOpen: false,
  },
  {
    id: 'closed',
    title: 'Closed',
    imageSrc: '/images/Dashboard_Home/CustomerCategories/closed.svg',
    color: 'text-emerald-600',
    isOpen: false,
  },
];
