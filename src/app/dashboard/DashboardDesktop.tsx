            ...
            <div className="w-full max-w-[680px] rounded-[8px] border border-[#E4E1DD] bg-[#FDFCFB] px-3 py-6">
              <div className="flex w-full flex-col gap-[14px]">
                ...
                <div className="grid w-full gap-3 lg:grid-cols-3 sm:grid-cols-2" style={{ filter: "drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.05))" }}>
                  {tasks.map((task, idx) => (
                    <div key={idx} className="flex h-[70px] w-full flex-col items-center justify-center rounded-[8px] border border-[#03121F]/20 bg-[#FDFCFB] shadow-[0_4px_4px_rgba(0,0,0,0.05)]">
            ...
            <div className="w-full max-w-[680px] rounded-[8px] border border-[#E4E1DD] bg-[#FDFCFB] px-3 py-6">
              <div className="flex w-full flex-col gap-[14px]">
                ...
                <div className="grid w-full gap-3 sm:grid-cols-2">
                  {messages.map((m, i) => (
                    <div key={i} className="flex h-[61px] w-full items-center gap-4 rounded-[8px] border border-[rgba(70,70,70,0.25)] bg-[#FDFCFB] px-[6px] py-2 shadow-[0_4px_4px_rgba(0,0,0,0.05)]">
            ...
            <div className="w-full max-w-[680px] rounded-[8px] border border-[#E4E1DD] bg-[#FDFCFB] px-3 py-6">
              <div className="flex w-full flex-col gap-[14px]">
                ...
                <div className="grid w-full gap-3 lg:grid-cols-3 sm:grid-cols-2">
                  {categories.map((c, i) => (
                    <div key={i} className="flex h-[70px] w-full flex-col items-center justify-center rounded-[8px] border border-[#03121F]/20 bg-[#FDFCFB] shadow-[0_4px_4px_rgba(0,0,0,0.05)]">
