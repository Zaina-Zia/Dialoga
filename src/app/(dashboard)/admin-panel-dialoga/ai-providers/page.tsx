      ...
      <section className="lg:hidden w-full max-w-[390px] min-h-dvh mx-auto flex flex-col items-center pt-8 pb-8 gap-4">
        ...
        <div className="w-[390px] px-3 flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <h1 className="text-[21px] leading-[32px] font-semibold text-black">AI Providers</h1>
            {!showForm && (
          ...
          {showForm ? (
            ...
            <div className="w-full rounded-[8px] border border-[#E4E1DD] bg-[#FDFCFB] p-3">
              {providers.length === 0 ? (
                <div className="text-center py-8 text-[#464646] text-[15px]">No AI providers configured yet.</div>
              ) : (
        ...
        <div className="w-full max-w-[1512px] flex flex-col gap-8 py-8 px-6 lg:px-10 2xl:px-[55px]">
          ...
          <div className="w-full flex flex-col gap-6">
            ...
            {showForm ? (
              ...
              <div className="w-full max-w-[680px] rounded-[8px] border border-[#E4E1DD] bg-[#FDFCFB] p-6">
                {providers.length === 0 ? (
                  <div className="text-center py-12 text-[#464646] text-[15px]">No AI providers configured yet. Click "Add Provider" to get started.</div>
                ) : (
