      ...
      <section className="lg:hidden w-full max-w-[390px] min-h-dvh flex flex-col items-center bg-[#F5F3F1] pt-8 px-4 pb-[107px] gap-8">
        ...
        <AuthCard className="w-[364px] min-h-[380px] bg-[#FDFCFB] border border-[#E4E1DD] rounded-[8px] pt-6 pb-6 px-0 flex flex-col items-center gap-4">
          ...
          <AuthForm noValidate onSubmit={handleSubmit} className="w-[364px] h-[260px] flex flex-col items-center gap-8">
            {/* Frame 11: 364x183, border-x, px-3, gap 31 */}
            <div className="w-[364px] h-[183px] flex flex-col items-center gap-[31px] border-x border-[#E4E1DD] px-3">
              {/* Fields container 332x183 */}
              <div className="w-[332px] h-[183px] flex flex-col gap-2">
                {/* Field 1 */}
                <div className="w-[332px] h-[72px] flex flex-col gap-1">
                  <label htmlFor="password" className="w-[330px] h-[27px] text-[18px] leading-[27px] font-medium text-black">Enter Your New Password</label>
                  <Input id="password" name="password" type="password" className="w-[330px] h-[45px] rounded-[8px] border border-[#03121F]/20 bg-[#FDFCFB] px-3 text-[16px] text-[#03121F] shadow-[0_4px_4px_rgba(0,0,0,0.05)] outline-none focus:border-[#03121F]/40 focus:ring-2 focus:ring-[#03121F]/10" />
                  {passwordError && <AuthError message={passwordError} />}
                </div>

                {/* Field 2 */}
                <div className="w-[332px] h-[72px] flex flex-col gap-1">
                  <label htmlFor="confirm" className="w-[331px] h-[27px] text-[18px] leading-[27px] font-medium text-black">Confirm Your New Password</label>
                  <Input id="confirm" name="confirm" type="password" className="w-[331px] h-[45px] rounded-[8px] border border-[#03121F]/20 bg-[#FDFCFB] px-3 text-[16px] text-[#03121F] shadow-[0_4px_4px_rgba(0,0,0,0.05)] outline-none focus:border-[#03121F]/40 focus:ring-2 focus:ring-[#03121F]/10" />
            ...
            <div className="w-[364px] h-[45px] px-3">
              <Button type="submit" className="w-[340px] h-[45px] rounded-[8px] border border-[#03121F]/20 bg-[#09B558] text-[#FBF9F7] text-[18px] font-semibold leading-[27px] flex items-center justify-center shadow-[0_4px_4px_rgba(0,0,0,0.05)]">
                Continue
              </Button>
            </div>
          </AuthForm>
