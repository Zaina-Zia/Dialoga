  ...
  return (
    <main className="min-h-dvh w-full grid place-items-center">
      ...
      <section className="lg:hidden w-full max-w-[390px] min-h-dvh flex flex-col items-center bg-[#F5F3F1] pt-8 px-4 pb-[107px] gap-8">
        ...
        <AuthCard className="w-[358px] min-h-[316px] bg-[#FDFCFB] border border-[#E4E1DD] rounded-[8px] pt-6 pb-6 px-0 flex flex-col items-center gap-8">
          {/* Brand logo */}
          ...
          {/* Email input (332x45) */}
          <AuthForm noValidate onSubmit={handleSubmit} className="w-full flex flex-col items-center gap-2 px-3">
            <label htmlFor="email" className="w-[332px] text-[18px] leading-[18px] font-medium text-black">Email</label>
            <Input id="email" name="email" type="email" className="w-[332px] h-[45px] rounded-[8px] border border-[#03121F]/20 bg-[#FDFCFB] px-3 text-[16px] text-[#03121F] shadow-[0_4px_4px_rgba(0,0,0,0.05)] outline-none focus:border-[#03121F]/40 focus:ring-2 focus:ring-[#03121F]/10" />
            {emailError && <AuthError message={emailError} />}

            {/* Continue CTA (332x45) */}
            <Button type="submit" className="mt-6 w-[332px] h-[45px] rounded-[8px] border border-[#03121F33] bg-[#09B558] text-[#FBF9F7] text-[18px] font-semibold leading-[18px] flex items-center justify-center shadow-[0_4px_4px_rgba(0,0,0,0.05)]">
              Continue
            </Button>
          </AuthForm>
        </AuthCard>
      ...
      <section className="hidden lg:flex w-full min-h-dvh flex-col items-center bg-[#F5F3F1]">
        ...
        <div className="w-full flex items-start justify-center mt-[clamp(32px,10vh,135px)] pb-8">
          ...
          <AuthCard className="w-[436px] h-[398.2857px] bg-[#FBF9F7] shadow-[0_4px_4px_rgba(0,0,0,0.25)] rounded-[8px] p-8 flex items-center justify-center">
            {/* Inner card 372x334 with 32/16 paddings */}
            <AuthCard className="w-[372px] h-[334.2857px] bg-[#FBF9F7] shadow-[0_4px_4px_rgba(0,0,0,0.25)] rounded-[8px] pt-8 pb-8 px-4 flex flex-col items-center gap-4">
              ...
              <div className="w-[340px] flex flex-col items-center gap-4">
                ...
                <AuthForm noValidate onSubmit={handleSubmit} className="w-[340px] flex flex-col gap-4">
                  <div className="flex flex-col gap-2">
                    <label htmlFor="d-email" className="text-[18px] leading-[18px] font-medium text-black">Email</label>
                    <Input id="d-email" name="email" type="email" className="w-[340px] h-[45px] rounded-[8px] border border-[#03121F]/20 bg-[#FDFCFB] px-3 text-[16px] text-[#03121F] shadow-[0_4px_4px_rgba(0,0,0,0.05)] outline-none focus:border-[#03121F]/40 focus:ring-2 focus:ring-[#03121F]/10" />
                    {emailError && <AuthError message={emailError} />}
                  </div>

                  <Button type="submit" className="w-[340px] h-[45px] rounded-[8px] border border-[#03121F]/20 bg-[#09B558] text-[#FBF9F7] text-[18px] font-semibold leading-[18px] flex items-center justify-center shadow-[0_4px_4px_rgba(0,0,0,0.05)]">Continue</Button>
                </AuthForm>
              </div>
            </AuthCard>
          </AuthCard>
